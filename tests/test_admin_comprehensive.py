...
# ============================================================================
# WHO AM I ADMIN TESTS
# ============================================================================

class TestAdminWhoAmI:
    """Tests for Who Am I image management."""
    
    def test_who_am_i_page_loads(self, authenticated_client):
        """Test Who Am I admin page loads."""
        response = authenticated_client.get('/admin/who-am-i')
        assert response.status_code in [200, 302], "Who Am I page should load"
    
    def test_get_who_am_i_image(self, authenticated_client):
        """Test getting a Who Am I image."""
        response = authenticated_client.get('/admin/who-am-i/get/1')
        assert response.status_code in [200, 404], "Get image should respond"
    
    def test_toggle_who_am_i_image(self, authenticated_client):
        """Test toggling Who Am I image active status."""
        response = authenticated_client.post('/admin/who-am-i/toggle/1')
        # May redirect after toggle
        assert response.status_code in [200, 302, 404], "Toggle should respond"
    
    def test_delete_who_am_i_image(self, authenticated_client):
        """Test deleting a Who Am I image."""
        response = authenticated_client.post('/admin/who-am-i/delete/999999')
        # May redirect after delete attempt
        assert response.status_code in [200, 302, 404], "Delete should respond"
