-- ============================================================
-- PRE-FLIGHT CLEANUP SQL FOR FUNCTIONS TOPIC
...
-- Step 2: Check existing functions ADAPTIVE questions
...
-- Step 3: DELETE existing functions ADAPTIVE questions ONLY
DELETE FROM questions_adaptive WHERE topic = 'functions';
...
FROM questions_adaptive 
WHERE topic = 'functions' AND mode = 'jc_exam'
GROUP BY difficulty_level
ORDER BY difficulty_level;
...
-- sqlite3 instance/mathquiz.db "DELETE FROM questions_adaptive WHERE topic = 'functions';"

-- Check count:
-- sqlite3 instance/mathquiz.db "SELECT COUNT(*) FROM questions_adaptive WHERE topic = 'functions';"

-- After running generator, verify by level:
-- sqlite3 instance/mathquiz.db "SELECT difficulty_level, COUNT(*) FROM questions_adaptive WHERE topic = 'functions' GROUP BY difficulty_level;"
